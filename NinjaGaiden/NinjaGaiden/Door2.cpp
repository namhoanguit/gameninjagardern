...
#define PATH_MANOBJ "res\\images\\ground\\10-3.png"
...
Door2::Door2()
{
	...
	m_sprite = new fwSprite(m_texture, D3DXVECTOR3(0, 0, 0), 2, 2, 22, 96);
...
void Door2::updateCollide(SweepAABB col, DWORD deltatime)
{
	float colTime = 1.0f;
