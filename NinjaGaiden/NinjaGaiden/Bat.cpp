...
#define PATH_MANOBJ "res\\images\\enemy\\0.png"
#define VELOCITY 200

Bat::Bat()
{
	m_Id = idPLAYER;
	m_Pos = D3DXVECTOR3(50, 50, 0);
...
void Bat::update(DWORD deltatime)
{
...
void Bat::Going(DWORD deltatime)
{
...
void Bat::updateCollide(SweepAABB col, DWORD deltatime)
{
	float colTime = 1.0f;
