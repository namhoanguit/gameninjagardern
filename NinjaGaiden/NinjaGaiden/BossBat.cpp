...
#define PATH_MANOBJ "res\\images\\boss\\0.png"
#define VELOCITY 200
...
BossBat::BossBat()
{
	...
	m_sprite = new fwSprite(m_texture, D3DXVECTOR3(0, 0, 0), 3, 3, 46, 96);
...
void BossBat::update(DWORD deltatime)
{
...
void BossBat::Going(DWORD deltatime)
{
...
void BossBat::updateCollide(SweepAABB col, DWORD deltatime)
{
	float colTime = 1.0f;
